...
@section('title','商铺商品管理')
	@section('goods')
	<li class="has-sub active">
        <a href="ui-panels.html">
            <i class="linecons-note"></i>
            <span class="title">商铺商品管理</span>
        </a>
...
<div id="page-wrapper" style="min-height: 394px;">
  ...
  <div class="panel-heading">
   ...
   <table id="example-1" class="table table-striped table-bordered "  role="grid" aria-describedby="example-1_info" style="width: 100%;" width="100%" cellspacing="0"> 
    <thead> 
     ...
     <!--  <th class="" tabindex="0" aria-controls="example-1" rowspan="1" colspan="1" style="width: 90px;" aria-label="Salary: activate to sort column ascending">
      ...
      <th class="" tabindex="0" aria-controls="example-1" rowspan="1" colspan="1" style="width: 90px;" aria-label="Salary: activate to sort column ascending">
       ...
       <th class="" tabindex="0" aria-controls="example-1" rowspan="1" colspan="1" style="width:120px;" aria-label="Salary: activate to sort column ascending">
      操作
      </th>
     </tr> 
    </thead> 
    ...
    <tbody> 
    <form action='/admin/shop/lunbo' method='get'>
    @foreach($goods as $k=>$v)
     <tr role="row" class="odd"> 
      <td class="_1"> <input type='checkbox' name='hobby[]' value='{{$v->gid}}'>{{$v->gid}} </td> 
      <td> {{$v->gname}} </td> 
      <td> {{$v->tname}} </td> 
      <td> {{$v->price}} </td> 
