                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <form role="form" action="/admin/users/updetail" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input <?php if($detail->sex == 'w'){echo 'checked';} ?> name="sex" value="w" id="female" style="margin: 0px;" type="radio">女
                                    <input <?php if($detail->sex == 'm'){echo 'checked';} ?> name="sex" value="m" id="male"  type="radio">男
                            ...
                            <div class="form-group">
                            <label>个人信息：&nbsp;</label>
                            <textarea name="message" class="form-control" cols="5" placeholder="随便写点什么，让大家了解你吧。" id="field-5">{{$detail->message}}</textarea>   
                            </div>
                                {{csrf_field()}}
                                <br>
