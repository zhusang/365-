...
@section('title','注册')
@section('css')
      <link media="all" href="/homecss/logincss/css/index_r.css" type="text/css" rel="stylesheet">
@endsection
@section('con') 
               ...
               <form action="/user/insert" method="post">
                <div class="ui-sign-item ui-name-item clearfix mb" style="display:inline-block">
                        ...
                        <div class="ui-sign-item ui-sign-common-item checkword clearfix mb">
                            ...
                            <input maxlength="32" data-type="code" class="ui-input short_text" name="pcode" placeholder="验证码" style="border-color:#CFCFCF;height:40px;" type="text">
                        </div>
                        
                        <div class="ui-sign-item ui-sign-common-item checkword clearfix mb">
                        <input style="width:300px;" maxlength="32" data-type="code" class="ui-input short_text" name="upwd" placeholder="请设置密码" style="border-color:#CFCFCF;height:40px;" type="password"> 
                        ...
                        <div id="appendchk" class="rg_submit mb">
                            <input value="立即注册" class="sub" type="submit">
                        </div>
                    </form>
                </div>
                 
                <div class="rg_rule mb">
                    <label><input value="1" name="read" class="check" checked="checked" type="checkbox"><span> 我已阅读并且同意<a target="_blank" href="http://www.mogujie.com/rule/mogu?categoryId=309&amp;ruleId=890&amp;ptp=1.yaDcAHLb.0.41.UNoUH" style="text-decoration:underline">《蘑菇街网络服务使用协议》</a></span></label>
                </div>
                <div class="rg_login">
...
@endsection
@section('js')
    <script type="text/javascript" src="/homecss/logincss/js/index_reqister.js"></script>
@endsection