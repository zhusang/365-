...
<div class="header_mid clearfix">
  ...
  <img src="/ordercss/04.jpg" width="100" height="100"> 
   ...
   <ul class="mu_nav_item"> 
       ...
       <li class="c"> <a href="/home/order/Hsindex?uid={{session('uid')}}"> 订单回收站 <i id="recyleOrder" class="mu_nav_count"><i class="mu_nav_count_arw"></i></i> </a> </li> 
   </ul> </div> 
            ...
            <tbody>
              ...
              <tr class="order-table-item last">
                <td class="goods">
                  ...
                  <div class="desc">
                    <p><a href="/home/goods/index?gid={{$goods[$v->gid]->gid}}" target="_blank">{{$goods[$v->gid]->gname}}
                      </a>
                      <a class="snapshot" href="/home/order/phone?gid={{$goods[$v->gid]->gid}}" target="_blank">[交易快照]</a>
                    </p>
                    <p>颜色：浅 紫</p>
                    <p>尺码：均码</p>
                    ...
                    <td class="price">  <p class="price-old">{{$goods[$v->gid]->price}}</p>  <p>{{$goods[$v->gid]->tprice}}</</p> </td> <td class="quantity">{{$v->buycnt}}</td> <td class="aftersale">  </td>  <td class="total" rowspan="1">  <p class="total-price">￥ {{$goods[$v->gid]->tprice*$v->buycnt}}</p>   <p>  (包邮) </p>   </td> <td class="status" rowspan="1"> <p class=""> 交易取消 </p> <a href="/home/order/hsdetail?hid={{$v->hid}}" class="order-link go-detail-link" target="_blank">订单详情</a>  </td> 
